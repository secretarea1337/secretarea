...
export const translations: Translations = {
    ...
    'Now you can have it thanks for respect SecretArea Guidelines and instructions, all this for you. 🥳': { en: 'Now you can have it thanks for respect SecretArea Guidelines and instructions, all this for you. 🥳', fr: 'Maintenant, vous pouvez l\'avoir grâce au respect des directives et instructions de SecretArea, tout ça pour vous. 🥳', es: 'Ahora puedes tenerlo gracias por respetar las directrices e instrucciones de SecretArea, todo esto para ti. 🥳', ar: 'الآن يمكنك الحصول عليه بفضل احترام إرشادات وتعليمات SecretArea، كل هذا من أجلك. 🥳' },
    'Now you can have it thanks for respect N E X A 1337 Guidelines and instructions, all this for you. 🥳': { en: 'Now you can have it thanks for respect SecretArea Guidelines and instructions, all this for you. 🥳', fr: 'Maintenant, vous pouvez l\'avoir grâce au respect des directives et instructions de SecretArea, tout ça pour vous. 🥳', es: 'Ahora puedes tenerlo gracias por respetar las directrices e instrucciones de SecretArea, todo esto para ti. 🥳', ar: 'الآن يمكنك الحصول عليه بفضل احترام إرشادات وتعليمات SecretArea، كل هذا من أجلك. 🥳' },
    ...
    'SecretArea Says': { en: 'SecretArea Says', fr: 'SecretArea dit', es: 'SecretArea dice', ar: 'يقول SecretArea' },
    'N E X A 1337 Says': { en: 'SecretArea Says', fr: 'SecretArea dit', es: 'SecretArea dice', ar: 'يقول SecretArea' },
    ...
    'SecretArea Says :': { en: 'SecretArea Says :', fr: 'SecretArea Dit :', es: 'SecretArea Dice :', ar: 'SecretArea يقول :' },
    'N E X A 1337 Says :': { en: 'SecretArea Says :', fr: 'SecretArea Dit :', es: 'SecretArea Dice :', ar: 'SecretArea يقول :' },
    ...
    'SecretArea Ecosystem': { en: 'SecretArea Ecosystem', fr: 'Écosystème SecretArea', es: 'Ecosistema SecretArea', ar: 'نظام SecretArea' },
    'N E X A 1337 Ecosystem': { en: 'SecretArea Ecosystem', fr: 'Écosystème SecretArea', es: 'Ecosistema SecretArea', ar: 'نظام SecretArea' },
    ...
    'SecretArea Development Roadmap': { en: 'SecretArea Development Roadmap', fr: 'Feuille de route de développement SecretArea', es: 'Hoja de ruta de desarrollo SecretArea', ar: 'خارطة طريق تطوير SecretArea' },
    'NEXA 1337 Development Roadmap': { en: 'SecretArea Development Roadmap', fr: 'Feuille de route de développement SecretArea', es: 'Hoja de route de développement SecretArea', ar: 'خارطة طريق تطوير SecretArea' },
